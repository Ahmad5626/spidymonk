...
$(document).ready(function(){
    const data = [
        ...
        {
            title: "Contact Us",
            description: "Contact Us Home / Contact Us Reach out to us Get in Touch Reach out to us for tailored digital solutions that drive results sollicitudin nec. Phone Number +91 95995 87855 Email Address hello@markoagency.com Office Address Marko HQ - 902 Digital Lane, San Francisco, CA 94110, USA",
            url: "contact.html"
        },
    ];
